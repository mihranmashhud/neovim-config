...
_G.packer_plugins = {
  ...
  ["nvim-autopairs"] = {
    loaded = true,
    path = "/home/mihranmashhud/.local/share/nvim/site/pack/packer/start/nvim-autopairs"
  },
  ["nvim-colorizer.lua"] = {
    loaded = true,
  ...
  ["nvim-tabline"] = {
    loaded = true,
    path = "/home/mihranmashhud/.local/share/nvim/site/pack/packer/start/nvim-tabline"
  },
  ["nvim-tree.lua"] = {
    loaded = true,
  ...
  ["twilight.nvim"] = {
    loaded = true,
    path = "/home/mihranmashhud/.local/share/nvim/site/pack/packer/start/twilight.nvim"
  },
  undotree = {
    loaded = true,
...
vim.cmd [[au FileType mkd ++once lua require("packer.load")({'vim-lexical', 'vim-litecorrect', 'vim-pencil', 'vim-table-mode', 'latex-unicoder.vim'}, { ft = "mkd" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'vim-headerguard'}, { ft = "c" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vimtex'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType latex ++once lua require("packer.load")({'vim-lexical', 'vim-litecorrect', 'vim-pencil', 'vim-table-mode', 'vimtex', 'latex-unicoder.vim'}, { ft = "latex" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-lexical', 'vim-litecorrect', 'vim-markdown-jekyll', 'vim-pencil', 'vim-table-mode', 'latex-unicoder.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'vim-lexical', 'vim-pandoc-syntax', 'vim-litecorrect', 'vim-markdown-jekyll', 'vim-pandoc', 'vim-pencil', 'vim-table-mode', 'latex-unicoder.vim'}, { ft = "pandoc" }, _G.packer_plugins)]]
