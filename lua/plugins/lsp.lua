...
local on_attach = function(client, bufnr)
	...
	end, { silent = true, desc = "Hover doc" })
	...
	end, { silent = true, desc = "View line diagnostics" })
	vim.keymap.set("n", "<leader>ld", function()
		require("lspsaga.diagnostic.show"):show_diagnostics({ cursor = true })
	end, { silent = true, desc = "View cursor diagnostics" })
	vim.keymap.set("n", "<leader>la", function()
		require("lspsaga.codeaction"):code_action()
	end, { silent = true, desc = "View code actions" })
	vim.keymap.set("n", "<leader>lD", ":ToggleDiag<CR>", { silent = true, desc = "Toggle diagnostics" })
	vim.keymap.set("n", "<space>lF", ":Format<CR>", { silent = true, desc = "Format file" })
	vim.keymap.set("v", "<space>lF", ":Format<CR>", { silent = true, desc = "Format file" })
end
