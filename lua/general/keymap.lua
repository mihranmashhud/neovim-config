local M = {}
M.group_names = {}
local function set_group_name(lhs, name) M.group_names[lhs] = name end
...
vim.keymap.set("n", "<leader>=", "<C-w>=",
               { silent = true, desc = "balance windows" })
vim.keymap.set("n", "<leader>,", ":Dashboard<CR>",
               { silent = true, desc = "start screen" })
vim.keymap.set("n", "<leader>c", ":Codi!!<CR>",
...
vim.keymap.set("n", "<leader>q", ":bd<CR>",
               { silent = true, desc = "quit buffer" })
vim.keymap.set("n", "<leader>j", ":lnext<CR>",
               { silent = true, desc = "loc next" })
...
vim.keymap.set("n", "<leader>an", ":DashboardNewFile<CR>",
...
vim.keymap.set("n", "<leader>s;", ":Telescope commands<CR>",
...
vim.keymap.set("n", "<leader>sc", ":Telescope git_commits<CR>",
               { silent = true, desc = "commits" })
vim.keymap.set("n", "<leader>sC", ":Telescope git_buffer_commits<CR>",
               { silent = true, desc = "buffer commits" })
...
vim.keymap.set("n", "<leader>sM", ":Telescope keymaps<CR>",
               { silent = true, desc = "keymaps" })
vim.keymap.set("n", "<leader>sp", ":Telescope help_tags<CR>",
               { silent = true, desc = "help tags" })
vim.keymap.set("n", "<leader>sP", ":Telescope tags<CR>",
               { silent = true, desc = "tags" })
vim.keymap.set("n", "<leader>ss", ":Telescope snippets snippets<CR>",
               { silent = true, desc = "snippets" })
vim.keymap.set("n", "<leader>sS", ":Telescope colorscheme<CR>",
               { silent = true, desc = "colorscheme" })
vim.keymap.set("n", "<leader>st", ":Telescope current_buffer_tags<CR>",
               { silent = true, desc = "buffer tags" })
vim.keymap.set("n", "<leader>sy", ":Telescope filetypes<CR>",
               { silent = true, desc = "filetypes" })
...
vim.keymap.set("n", "<leader>SL",
               ...
               { silent = true, desc = "last session in dir" })
vim.keymap.set("n", "<leader>Sl", ":SessionManager load_last_session<CR>",
               { silent = true, desc = "last session" })

set_group_name("<leader>x", "Execute")
vim.keymap.set("n", "<leader>xc",
               function() return require("general.debug").execute_line() end,
               { silent = true, desc = "current line" })
vim.keymap.set("n", "<leader>xf",
               function() return require("general.debug").load_file() end,
...
vim.keymap.set("n", "<leader>ga", ":Git add %<CR>",
               { silent = true, desc = "add file" })
vim.keymap.set("n", "<leader>gb", ":Git blame<CR>",
               { silent = true, desc = "blame" })
vim.keymap.set("n", "<leader>gB", ":GBrowse<CR>",
               { silent = true, desc = "browse" })
vim.keymap.set("n", "<leader>gc", ":Git commit<CR>",
               { silent = true, desc = "commit" })
...
vim.keymap.set("n", "<leader>gp", ":Git pull<CR>",
               { silent = true, desc = "pull" })
vim.keymap.set("n", "<leader>gP", ":Git push<CR>",
               { silent = true, desc = "push" })
vim.keymap.set("n", "<leader>gr", ":GRemove<CR>",
               { silent = true, desc = "remove" })
...
vim.keymap.set("n", "<leader>dr",
               function() return require"dap".repl.open() end,
               { silent = true, desc = "inspect in REPL" })
